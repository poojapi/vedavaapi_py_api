...
from vedavaapi import common, textract, ullekhanam
...
def setup_app():
    common.set_configuration(config_file_name=os.path.join(os.path.dirname(__file__), 'conf_local/server_config_new.json'))

    services = ['store', 'users', 'ullekhanam', 'textract']
